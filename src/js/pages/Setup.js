...
class Setup extends mixin(StoreMixin) {
  ...
  render() {
    let uiInstallerWarning = Hooks.applyFilter('uiInstallerWarning', (
      <p>
        Authentication is enabled by default. To change this, please reference the <a href={`${Config.documentationURI}/administration/installing/opt-out`} target="_blank">{Config.productName} documentation</a>.
      </p>
    ));
